...
from models.early_vit import vit_small_patch16_224_depth6, router_vit_small_patch16_224_depth12_6_e256, vit_base_patch16_224_depth6
from models.early_vit_partial_routing import router_vit_small_patch16_224_depth12_6_e256_partial_mlp, router_vit_small_patch16_224_depth12_6_e256_partial_attention, router_vit_small_patch16_224_depth12_8_e256_partial_mlp
...
try:
    ...
    print('deepspeed profiling enabled')
except ImportError as e:
    has_deepspeed_profiling = False
    print('deepspeed profiling disabled')
...
class BenchmarkRunner:
    def __init__(
        ...
        if torchscript:
            ...
            torch._dynamo.reset()
            print('compiling torch w/ torch.compile()')
...
class InferenceBenchmarkRunner(BenchmarkRunner):
    ...
    def run(self):
        ...
        # print('Allocated:', round(torch.cuda.max_memory_allocated(0) / 1024 ** 2, 1), 'MB')
        ...
        while retries:
            ...
            try:
                if has_deepspeed_profiling:
                    macs, _ = profile_deepspeed(self.model, self.input_size) #, detailed=True)
